          ...
          <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-blue-50/50">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Thank you for registering. We&#39;ve received your application
        ...
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-lg text-gray-600 max-w-md mx-auto">
              Join the Greater Dinajpur Freelancer Association and unlock a
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 border-t pt-6 border-gray-200">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div>
                    <label
                      htmlFor="presentAddress.division"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Division
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor="presentAddress.district"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      District
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor="presentAddress.upazila"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Upazila
                    </label>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label
                      htmlFor="presentAddress.postal_code"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Postal Code
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor="presentAddress.country"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Country
                    </label>
              ...
              <div className="space-y-4 border-t pt-6 border-gray-200">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div>
                    <label
                      htmlFor="permanentAddress.division"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Division
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor="permanentAddress.district"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      District
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor="permanentAddress.upazila"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                      Upazila
                    </label>
