...
const successStories = [
  ...
  },
  {
    ...
    story:
      "Successfully launched 3 mobile apps and built a reputation as a go-to mobile developer in the region.",
    joinedYear: "2020",
    category: "Mobile Dev",
      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover how our community members have transformed their careers,
            achieved financial independence, and built thriving businesses
            through dedication and community support.
          </p>
        </div>

        <div className="mb-16">
          <div className="grid lg:grid-cols-2 gap-8 relative z-50">
            {featuredStories.map((story) => (
              <Card
                key={story.id}
                // Added hover effects: scale, shadow, and translateY
                className="border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 overflow-hidden group"
              >
                ...
                <CardContent className="p-8">
                  <div className="flex items-start gap-6 mb-6">
                    <div className="relative">
                      ...
                      <div className="absolute -bottom-2 -right-2">
                        <Badge className="bg-gdfa-secondary text-white text-xs px-2 py-1">
                          Featured
                        </Badge>
                      </div>
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-gdfa-secondary font-semibold mb-2">
                        {story.role}
                      </p>
                  ...
                  <Link href={`/success-stories/${story.slug}`}>
                    <Button
                      className="w-full bg-gradient-to-r from-[var(--gdfa-secondary)]
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-50">
            {regularStories.map((story) => (
              <Card
                key={story.id}
                // Added hover effects: scale, shadow, and translateY
                className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 group"
              >
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gdfa-secondary font-semibold text-sm">
                        {story.role}
                      </p>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge className="bg-blue-100 text-gdfa-secondary text-xs">
                      {story.achievement}
                    </Badge>
                  </div>
        ...
        <Card className="border-0 shadow-2xl bg-gradient-to-br from-[var(--gdfa-primary)] to-[var(--gdfa-accent)] text-white overflow-hidden">
          ...
          <CardContent className="p-12 text-center relative z-10">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Our members&#39; collective success demonstrates the power of
